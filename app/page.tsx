...
export default function HomePage() {
  // Temporary verification - remove in production
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 mb-4 max-w-3xl mx-auto leading-relaxed font-medium">
            Transform your flexible work scheduling with our intelligent, fair,
            and transparent lottery system
          </p>

          <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
            Employees enter with secure PINs, winners are randomly selected, and
            ...
            <div className="card bg-white/80 backdrop-blur-sm p-8 border-2 border-transparent hover:border-blue-200 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-700 mb-8 leading-relaxed">
                  Create polls, manage employees, and conduct fair lottery
                  drawings with our comprehensive management dashboard
                </p>
              </div>
          ...
          <div className="group">
            <div className="card bg-white/80 backdrop-blur-sm p-8 border-2 border-transparent hover:border-green-200 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-700 mb-8 leading-relaxed">
                  Join polls using your secure PIN and select your preferred
                  flexible schedule spots with ease
                </p>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-green-800 text-sm leading-relaxed">
                      ...
                      participate. Check your email or company communication
                      channels.
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-5xl mx-auto mb-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our streamlined process ensures fairness and transparency in every
              lottery drawing
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Set available spots for AM, PM, and All-day shifts with custom
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Use secure PIN authentication to verify identity and select
                preferred flexible schedule spots
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Fair lottery algorithm randomly selects winners with instant
                notifications and transparent results
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="card bg-gradient-to-r from-blue-600 to-purple-700 p-12 text-white text-center">
            <h3 className="text-3xl font-bold mb-6">Why Choose FlexSpot?</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Cryptographically secure random selection ensures every
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Intuitive interface designed for both managers and
                      employees with minimal training required
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Live participation tracking and instant result
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Enterprise-grade security with PIN-based authentication
