// File: app/manager/dashboard/page.tsx (SIMPLIFIED)
"use client";
        ...
        <div>
          ...
          {polls.length === 0 ? (
            <div className="bg-white rounded-lg shadow-md p-8 text-center">
              ...
              <p className="text-gray-900 text-lg mb-2">No polls created yet</p>
              ...
              <div className="divide-y">
                {users.slice(0, 5).map((user) => (
                  ...
                  >
                    ...
                    <div className="font-mono text-sm text-gray-800">••••</div>
                  </div>
                ))}
                {users.length > 5 && (
